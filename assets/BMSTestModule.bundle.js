...
/******/ 	return __webpack_require__(__webpack_require__.s = "./builds/BMSTestModule.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./builds/BMSTestModule.js":
/*!*********************************!*\
  !*** ./builds/BMSTestModule.js ***!
  \*********************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/polyfill */ \"./node_modules/@babel/polyfill/lib/index.js\");\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var bms_expose_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! bms-expose-module */ \"./node_modules/bms-expose-module/dist/index.js\");\n/* harmony import */ var bms_expose_module__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(bms_expose_module__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _classes_Product__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../classes/Product */ \"./classes/Product.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n//If you require Polyfills, Async, await, Etc uncomment below line. Be mindful, bloats the bundle!.\n\n\n\n\nvar test =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(testVar) {\n    var product;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            console.log(\"hello from bundle UPDATED!!!again!!\");\n            product = new _classes_Product__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"IamProductHandle\", 1223);\n            console.log(product.handle);\n            console.log(product.id);\n            console.log(_classes_Product__WEBPACK_IMPORTED_MODULE_2__[\"default\"].staticVariable);\n            console.log(\"testVar is \", testVar);\n            sleep(3000).then(function () {\n              console.log(\"sleepttt\");\n            });\n            _context.prev = 7;\n            _context.next = 10;\n            return asyncSleep(2000);\n\n          case 10:\n            console.log(\"slept 2000\");\n            _context.next = 16;\n            break;\n\n          case 13:\n            _context.prev = 13;\n            _context.t0 = _context[\"catch\"](7);\n            console.log(_context.t0);\n\n          case 16:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this, [[7, 13]]);\n  }));\n\n  return function test(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar anotherModule = function anotherModule() {\n  console.log('hello from ANOTHER MODULE!!!');\n};\n\nvar sleep = function sleep(time) {\n  return new Promise(function (resolve, reject) {\n    setTimeout(function () {\n      resolve();\n    }, time);\n  });\n};\n\nvar asyncSleep =\n/*#__PURE__*/\nfunction () {\n  var _ref2 = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee2(time) {\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            _context2.next = 2;\n            return sleep(time);\n\n          case 2:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2, this);\n  }));\n\n  return function asyncSleep(_x2) {\n    return _ref2.apply(this, arguments);\n  };\n}();\n\nconsole.log('hi');\nObject(bms_expose_module__WEBPACK_IMPORTED_MODULE_1__[\"ExposeModule\"])({\n  BOLD: {\n    BMS: {\n      BUILDS: {\n        test: test\n      }\n    }\n  }\n});\nObject(bms_expose_module__WEBPACK_IMPORTED_MODULE_1__[\"ExposeModule\"])({\n  BOLD: {\n    BMS: {\n      BUILDS: {\n        anotherModule: anotherModule\n      }\n    }\n  }\n});\n\n//# sourceURL=webpack:///./builds/BMSTestModule.js?");
...
/***/ "./node_modules/bms-expose-module/dist/ExposeModule.js":
/*!*************************************************************!*\
  !*** ./node_modules/bms-expose-module/dist/ExposeModule.js ***!
  \*************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar bms_utility_helper_functions_1 = __webpack_require__(/*! bms-utility-helper-functions */ \"./node_modules/bms-utility-helper-functions/dist/index.js\");\nvar Window_1 = __webpack_require__(/*! ./Window */ \"./node_modules/bms-expose-module/dist/Window.js\");\nfunction ExposeModule(namespace) {\n    if (!bms_utility_helper_functions_1.IsObjectContainSpecifiedKeys(namespace, 1) || !bms_utility_helper_functions_1.IsObject(namespace) || bms_utility_helper_functions_1.IsEmptyObject(namespace)) {\n        // Object must contain one key, and not be empty, or else we break..\n        throw new Error('The namespace object provided is Malformed! Cannot expose module to Window!');\n    }\n    for (var _i = 0, _a = Object.keys(namespace); _i < _a.length; _i++) {\n        var key = _a[_i];\n        if (bms_utility_helper_functions_1.IsFunction(namespace[key])) {\n            Window_1.default.setNamespaceToWindow();\n            Window_1.default.setModule(namespace[key], key);\n            Window_1.default.resetWindow();\n            return;\n        }\n        Window_1.default.pushNamespace(key);\n        ExposeModule(namespace[key]); // one deeper, and I liked it.\n    }\n}\nexports.default = ExposeModule;\n\n\n//# sourceURL=webpack:///./node_modules/bms-expose-module/dist/ExposeModule.js?");

/***/ }),

/***/ "./node_modules/bms-expose-module/dist/Window.js":
/*!*******************************************************!*\
  !*** ./node_modules/bms-expose-module/dist/Window.js ***!
  \*******************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar Window = /** @class */ (function () {\n    function Window() {\n        if (!Window.instance) {\n            // if an instance does not exist\n            this.pointerWindow = window || {};\n            this.referenceWindow = this.pointerWindow;\n            this.arrayNames = [];\n            Window.instance = this;\n        }\n        return Window.instance;\n    }\n    Window.prototype.pushNamespace = function (property) {\n        this.arrayNames.push(property);\n    };\n    Window.prototype.setNamespaceToWindow = function () {\n        var _this = this;\n        this.arrayNames.forEach(function (key) {\n            _this.pointerWindow[key] = _this.pointerWindow[key] || {};\n            _this.pointerWindow = _this.pointerWindow[key];\n        });\n        this.arrayNames = []; // clear the array after done\n    };\n    Window.prototype.getWindow = function () {\n        return this.pointerWindow;\n    };\n    Window.prototype.getReferenceWindow = function () {\n        return this.referenceWindow;\n    };\n    Window.prototype.resetWindow = function () {\n        this.pointerWindow = window || {};\n        this.referenceWindow = window || {};\n    };\n    Window.prototype.setModule = function (module, moduleName) {\n        this.pointerWindow[moduleName] = module;\n    };\n    return Window;\n}());\nvar instance = new Window();\nexports.default = instance; // Singleton pattern. only exposing this one instance.\n\n\n//# sourceURL=webpack:///./node_modules/bms-expose-module/dist/Window.js?");

/***/ }),

/***/ "./node_modules/bms-expose-module/dist/index.js":
/*!******************************************************!*\
  !*** ./node_modules/bms-expose-module/dist/index.js ***!
  \******************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar ExposeModule_1 = __webpack_require__(/*! ./ExposeModule */ \"./node_modules/bms-expose-module/dist/ExposeModule.js\");\nexports.ExposeModule = ExposeModule_1.default;\n\n\n//# sourceURL=webpack:///./node_modules/bms-expose-module/dist/index.js?");

/***/ }),

/***/ "./node_modules/bms-utility-helper-functions/dist/GetObjectKeys.js":
/*!*************************************************************************!*\
  !*** ./node_modules/bms-utility-helper-functions/dist/GetObjectKeys.js ***!
  \*************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\n/**\n *\n * @param variable - a Variable to test\n * @returns {boolean} - Return true if variable is an object, else returns false\n */\nfunction isObject(variable) {\n    return typeof variable === 'object' && !Array.isArray(variable) && variable !== null;\n}\nexports.default = isObject;\n\n\n//# sourceURL=webpack:///./node_modules/bms-utility-helper-functions/dist/IsObject.js?");

/***/ }),

/***/ "./node_modules/bms-utility-helper-functions/dist/IsObjectContainSpecifiedKeys.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/bms-utility-helper-functions/dist/IsObjectContainSpecifiedKeys.js ***!
  \****************************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar GetObjectKeys_1 = __webpack_require__(/*! ./GetObjectKeys */ \"./node_modules/bms-utility-helper-functions/dist/GetObjectKeys.js\");\nexports.GetObjectKeys = GetObjectKeys_1.default;\nvar IsEmptyObject_1 = __webpack_require__(/*! ./IsEmptyObject */ \"./node_modules/bms-utility-helper-functions/dist/IsEmptyObject.js\");\nexports.IsEmptyObject = IsEmptyObject_1.default;\nvar IsFunction_1 = __webpack_require__(/*! ./IsFunction */ \"./node_modules/bms-utility-helper-functions/dist/IsFunction.js\");\nexports.IsFunction = IsFunction_1.default;\nvar IsObject_1 = __webpack_require__(/*! ./IsObject */ \"./node_modules/bms-utility-helper-functions/dist/IsObject.js\");\nexports.IsObject = IsObject_1.default;\nvar IsObjectContainSpecifiedKeys_1 = __webpack_require__(/*! ./IsObjectContainSpecifiedKeys */ \"./node_modules/bms-utility-helper-functions/dist/IsObjectContainSpecifiedKeys.js\");\nexports.IsObjectContainSpecifiedKeys = IsObjectContainSpecifiedKeys_1.default;\n\n\n//# sourceURL=webpack:///./node_modules/bms-utility-helper-functions/dist/index.js?");
